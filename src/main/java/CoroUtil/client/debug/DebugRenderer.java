...
public class DebugRenderer {
    ...
    public static void renderBatch(Tessellator tessellator, BufferBuilder bufferBuilder) {
        ...
        //Minecraft.getInstance().textureManager.bindTexture(net.minecraft.client.renderer.texture.TextureMap.LOCATION_BLOCKS_TEXTURE);
        //Minecraft.getInstance().textureManager.bindTexture(new ResourceLocation("textures/particle/particles.png"));
