...
public class ItemTropicalFishingRod extends Item 
{
    ...
    public ItemStack onItemRightClickSpecial(ItemStack var1, World var2, EntityPlayer var3, EntityLivingBase entAIUser) {
    	...
    	if (inv != null) {
	    	if(inv.fishEntity != null) {
	            ...
	            var2.playSoundAtEntity(entAIUser, "random.bow", 0.5F, 0.4F / (itemRand.nextFloat() * 0.4F + 0.8F));
	            
	            if(!var2.isRemote) {
	                var2.spawnEntityInWorld(new EntityTropicalFishHook(var2, entAIUser, 2F));
	            }
