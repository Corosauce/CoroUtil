...
public class EntityBatSmart extends CreatureEntity implements IFlyingAnimal
{
    ...
    protected void registerGoals()
    {
        ...
        //this.tasks.addGoal(0, new EntityAIPanic(this, 1.25D));
        this.tasks.addGoal(0, new SwimGoal(this));
        this.tasks.addGoal(1, new LookAtGoal(this, PlayerEntity.class, 8.0F));
        //this.tasks.addGoal(2, this.aiSit);
        //this.tasks.addGoal(2, new EntityAIFollowOwnerFlying(this, 1.0D, 5.0F, 1.0F));
        this.tasks.addGoal(2, new WaterAvoidingRandomFlyingGoal(this, 1.0D));
        //this.tasks.addGoal(3, new EntityAILandOnOwnersShoulder(this));
        //this.tasks.addGoal(3, new EntityAIFollow(this, 1.0D, 3.0F, 7.0F));
    }
