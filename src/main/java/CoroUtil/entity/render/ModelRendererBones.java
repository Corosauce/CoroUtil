	        ...
	        if (!this.isHidden)
	        {
	            if (this.showModel)
	            {
	                ...
	                if (animData.rotateMode == 0) {
	                    ...
	                    //wacky attempt at fixing our axis/inversion issues...
	                    if (boxName.equals("head")) {
	                    ...
	                    FloatBuffer buffer = ByteBuffer.allocateDirect(4*16).order(ByteOrder.nativeOrder()).asFloatBuffer().put(animData.matrix);
	    				buffer.flip();
