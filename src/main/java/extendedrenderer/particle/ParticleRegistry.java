...
public class ParticleRegistry {
	...
	public static TextureAtlasSprite cloud256_scratch;
	...
	public static void init(TextureStitchEvent.Pre event) {
		...
		cloud256_scratch = event.getMap().registerSprite(new ResourceLocation(ExtendedRenderer.modid + ":particles/cloud256_scratch"));
