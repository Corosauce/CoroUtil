...
public class ParticleBubbleTemp extends Particle
{
    public ParticleBubbleTemp(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn)
    {
    ...
    public static class Factory implements IParticleFactory
        {
            ...
            {
                return new ParticleBubbleTemp(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
            }
        }
}