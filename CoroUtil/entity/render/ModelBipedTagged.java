...
import CoroUtil.ability.AbilityAnimationTags;
import CoroUtil.bt.IBTAgent;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

@SideOnly(Side.CLIENT)
public class ModelBipedTagged extends ModelBiped
{

    public ModelBipedTagged()
    {
        this(0.0F);
    }

    public ModelBipedTagged(float par1)
    {
        this(par1, 0.0F, 64, 32);
    }

    public ModelBipedTagged(float par1, float par2, int par3, int par4)
    {
        ...
        this.bipedRightArm = new ModelRenderer(this, AbilityAnimationTags.armRight);
        bipedRightArm.setTextureOffset(40, 16);
        this.bipedRightArm.addBox(-3.0F, -2.0F, -2.0F, 4, 12, 4, par1);
        this.bipedRightArm.setRotationPoint(-5.0F, 2.0F + par2, 0.0F);
        this.bipedLeftArm = new ModelRenderer(this, AbilityAnimationTags.armLeft);
