...
public class SelectorThreshold extends Selector {
	...
	public SelectorThreshold(Behavior parParent, int[] parRef, int parThreshold) {
		super(parParent);
		valRef = parRef;
		threshold = parThreshold;
	}
	
	public SelectorThreshold(Behavior parParent, int[] parRef, int parThreshold, Behavior ifLessThan, Behavior ifMoreThanOrEqual) {
